            ...
            <div class="settings-page-area bg-secondary section-space-bottom">
                <div class="container">
                    ...
                    <div class="row settings-wrapper">
                        ...
                        <div class="alert alert-danger">
                            <strong>Bilgi!</strong> Şifreniz En Az 6 Karakter Olmalıdır!
                        </div>
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12"> 
                                ...
                                <div class="settings-details tab-content">
                                    <div class="tab-pane fade active in" id="Personal">
                                        ...
                                        <p>Başvuru işleminizi tamamlamak için tüm bilgilerinizi eksiksiz ve doğru olarak girilmesine özen gösteriniz. Eksik yada hatalı bilgi olduğunda başvurunuz iptal edilecektir.</p> 
                                        ...
                                        <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="custom-select">
                                                        <select name="kullanici_tip" id="kullanici_tip" class='select2'>
                                                            ...
                                                            <option <?php if ($kullanicicek['kullanici_tip']=="PERSONAL") {
                                                                echo "selected";
                                                            } 
                                                            ?>
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="checkbox">
                                                <div class="col-sm-9">
                                                <label><input type="checkbox" required="" value="">Kullanım şartlarını okudum, kabul ediyorum.</label>
                                                </div>
                                            </div>
                                            </div>
