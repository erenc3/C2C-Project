                ...
                <div class="container">
                    ...
                    <tbody>
                        <tr>
                            <td data-th="Product">
                                <div class="row">
                                    <div  class="col-sm-2 hidden-xs"><img style="width: 65px; height: 65px;" src="<?php echo $uruncek['urunfoto_resimyol'] ?>" alt="<?php echo $uruncek['urun_ad'] ?>" class="img-responsive"/></div>
                                    <div class="col-sm-10">
                    ...
                    <tfoot>
                        ...
                        <tr>
                            ...
                            <td><a href="#" class="btn btn-success btn-block">Siparişi Tamamla <i class="fa fa-angle-right"></i></a></td>
                        </tr>
                    </tfoot>
                </table>
